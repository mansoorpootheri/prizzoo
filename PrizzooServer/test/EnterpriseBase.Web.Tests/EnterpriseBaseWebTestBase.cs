...
public abstract class EnterpriseBaseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static EnterpriseBaseWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(EnterpriseBaseWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<EnterpriseBaseDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<EnterpriseBaseDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<EnterpriseBaseDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<EnterpriseBaseDbContext, Task<T>> func)
    {
        T result;
