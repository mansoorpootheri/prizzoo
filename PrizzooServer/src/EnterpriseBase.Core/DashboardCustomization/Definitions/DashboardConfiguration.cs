...
using EnterpriseBase.DashboardCustomization.Definitions.Cache;
    ...
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var dateRangeFilter = new WidgetFilterDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            var simplePermissionDependencyForTenantDashboard =
                new EnterpriseBaseSimplePermissionDependency(PermissionNames.Pages_Tenant_Dashboard);

            var dailySales = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.DailySales,
                "WidgetDailySales",
            ...
            var generalStats = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new EnterpriseBaseSimplePermissionDependency(
                    requiresAll: true,
            ...
            var profitShare = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                "WidgetProfitShare",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var memberActivity = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
            ...
            var regionalStats = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                "WidgetRegionalStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var salesSummary = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                "WidgetSalesSummary",
                usedWidgetFilters: new List<string>() {dateRangeFilter.Id},
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            ...
            var topStats = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: simplePermissionDependencyForTenantDashboard
            );
            ...
            var simplePermissionDependencyForHostDashboard =
                new EnterpriseBaseSimplePermissionDependency(PermissionNames.Pages_Administration_Host_Dashboard);

            var incomeStatistics = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
            ...
            var hostTopStats = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Host.TopStats,
                "WidgetTopStats",
                side: MultiTenancySides.Host,
                permissionDependency: simplePermissionDependencyForHostDashboard
            );
            ...
            var editionStatistics = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
            ...
            var subscriptionExpiringTenants = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
            ...
            var recentTenants = new WidgetDefinition(
                EnterpriseBaseDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                "WidgetRecentTenants",
                side: MultiTenancySides.Host,
                usedWidgetFilters: new List<string>() {dateRangeFilter.Id},
                permissionDependency: simplePermissionDependencyForHostDashboard
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                EnterpriseBaseDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                EnterpriseBaseDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
