...
/// </summary>
public class EnterpriseBaseSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public EnterpriseBaseSimplePermissionDependency()
    {
    ...
    public EnterpriseBaseSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public EnterpriseBaseSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
