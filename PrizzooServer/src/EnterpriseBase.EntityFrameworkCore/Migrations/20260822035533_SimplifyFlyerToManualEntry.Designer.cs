...
namespace EnterpriseBase.Migrations
{
    ...
    [Migration("20260822035533_SimplifyFlyerToManualEntry")]
    partial class SimplifyFlyerToManualEntry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnterpriseBase.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EnterpriseBase.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EnterpriseBase.Authorization.Users.UserBranchMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EnterpriseBase.Branches.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EnterpriseBase.Employees.Employee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EnterpriseBase.Employees.EmployeeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EnterpriseBase.Geography.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EnterpriseBase.Geography.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EnterpriseBase.Geography.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EnterpriseBase.MasterData.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EnterpriseBase.MasterData.Unit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EnterpriseBase.MultiTenancy.SubscriptionRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EnterpriseBase.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("LastAmountPaid")
                        .HasColumnType("numeric");

                    b.Property<DateTime?>("LastBillingDateUtc")
                        .HasColumnType("timestamp");
            ...
            modelBuilder.Entity("EnterpriseBase.Pricing.Flyer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EnterpriseBase.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EnterpriseBase.Taxes.Tax", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("ApplyOnServiceCharge")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("EnterpriseBase.Editions.EnterpriseEdition", b =>
                {
                    ...
                    b.Property<string>("HsnSacCode")
                        ...
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasDefaultValue("998314");

                    b.Property<bool>("IsPriceInclusiveOfGst")
                        .HasColumnType("boolean");
                    ...
                    b.HasDiscriminator().HasValue("EnterpriseEdition");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EnterpriseBase.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EnterpriseBase.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EnterpriseBase.Authorization.Roles.Role", b =>
                {
                    b.HasOne("EnterpriseBase.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("EnterpriseBase.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("EnterpriseBase.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EnterpriseBase.Authorization.Users.UserBranchMapping", b =>
                {
                    b.HasOne("EnterpriseBase.Branches.Branch", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EnterpriseBase.Authorization.Users.User", "User")
            ...
            modelBuilder.Entity("EnterpriseBase.Branches.Branch", b =>
                {
                    b.HasOne("EnterpriseBase.Geography.Country", "Country")
                        .WithMany()
                    ...
                    b.HasOne("EnterpriseBase.Geography.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("EnterpriseBase.Employees.Employee", b =>
                {
                    ...
                    b.HasOne("EnterpriseBase.Employees.EmployeeType", "EmployeeType")
                        .WithMany()
            ...
            modelBuilder.Entity("EnterpriseBase.MasterData.Product", b =>
                {
                    ...
                    b.HasOne("EnterpriseBase.Storage.BinaryObject", "Image")
                        .WithMany()
                        .HasForeignKey("ImageId");

                    b.HasOne("EnterpriseBase.MasterData.Unit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("EnterpriseBase.Pricing.Flyer", b =>
                {
                    ...
                    b.HasOne("EnterpriseBase.Stores.Store", "Store")
                        .WithMany()
            ...
            modelBuilder.Entity("EnterpriseBase.Stores.StoreChain", b =>
                {
                    b.HasOne("EnterpriseBase.Storage.BinaryObject", "Logo")
                        .WithMany()
