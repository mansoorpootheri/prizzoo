...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = EnterpriseBaseConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(EnterpriseBaseDbContext context)
    {
        _context = context;
    }
