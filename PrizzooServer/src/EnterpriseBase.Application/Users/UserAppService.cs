...
namespace EnterpriseBase.Users;
...
public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
{
    ...
    public override async Task<UserDto> CreateAsync(CreateUserDto input)
    {
        ...
        {
            await CheckMaxUserCountAsync(AbpSession.GetTenantId());
        }

        var existingUser = await _userManager.FindByEmailAsync(input.EmailAddress);
        if (existingUser != null)
        {
            throw new Exception(L("EmailAddressAlreadyInUse"));
        }
    ...
    {
        return query.OrderBy(input.Sorting ?? "id asc");
    }
    ...
    public async Task<bool> ResetPassword(ResetPasswordDto input)
    {
        ...
        {
            throw new Exception("Please log in before attempting to reset password.");
        }
        ...
        {
            throw new Exception("Your 'Admin Password' did not match the one on record.  Please try again.");
        }
        ...
        {
            throw new Exception("Only administrators may reset passwords.");
        }
    ...
    public async Task CheckMaxUserCountAsync(int tenantId)
    {
        ...
        var currentUserCount = await Repository.CountAsync();
