...
namespace EnterpriseBase.Web.Url
{
    public abstract class WebUrlServiceBase
    {
        ...
        public string WebSiteRootAddressFormat
        {
            get
            {
                ...
                return string.IsNullOrWhiteSpace(webSiteRootAddress) ? "https://localhost:44305/" : webSiteRootAddress;
            }
        }
        ...
        public string ServerRootAddressFormat
        {
            get
            {
                ...
                return string.IsNullOrWhiteSpace(serverRootAddress) ? "https://localhost:44305/" : serverRootAddress;
            }
        }
